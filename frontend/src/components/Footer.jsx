...
export default function Footer() {
    ...
    const calculateBusinessStatus = () => {
        ...
        } else if ((currentTime >= morningStart && currentTime < morningEnd) || (currentTime >= afternoonStart && currentTime < afternoonEnd)) {
            isOpen = true; message = 'Aperti ora';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                        ...
                        <div className="lg:col-span-1">
                            <div className="flex items-center mb-6">
                                <img className="h-16 w-auto object-contain filter brightness-0 invert" src="/logo_ideal.png" alt="Idealstampa Logo" />
                            </div>
                            <p className="text-gray-300 mb-6 leading-relaxed">
                                Dal 1995, la passione per la stampa di qualità.
                                Trasformiamo le tue idee in progetti tangibili con esperienza, precisione e innovazione.
                            </p>
                            ...
                            <div className={`inline-flex items-center space-x-2 px-4 py-2 rounded-full text-sm font-medium mb-6 ${
                                ...
                                <div className={`w-2 h-2 rounded-full ${businessStatus.isOpen ? 'bg-green-400' : 'bg-red-400'} ${businessStatus.isOpen ? 'animate-pulse' : ''}`}></div>
                                <span>{businessStatus.message}</span>
                            </div>

                            <div className="flex space-x-4">
                                <a href="#" className="bg-gray-800 hover:bg-teal-600 p-3 rounded-full transition-colors duration-300 group" aria-label="Facebook">
                                    <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/>
                                    </svg>
                                </a>
                                <a href="#" className="bg-gray-800 hover:bg-pink-600 p-3 rounded-full transition-colors duration-300 group" aria-label="Instagram">
                                    <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                                        <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"/>
                                    </svg>
                                </a>
                                <a href="https://wa.me/393770802322" target="_blank" rel="noopener noreferrer"
                                   className="bg-gray-800 hover:bg-green-600 p-3 rounded-full transition-colors duration-300 group" aria-label="WhatsApp">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                {quickLinks.map((link, index) => (
                                    <li key={index}>
                                        <a href={link.href} className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center group">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                {services.map((service, index) => (
                                    <li key={index}>
                                        <a href={service.href} className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center group">
                                            <span className="opacity-0 group-hover:opacity-100 mr-2 transition-opacity">→</span>
                                            {service.name}
                                        </a>
                                    </li>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start space-x-3 group">
                                    ...
                                    <p className="text-gray-300">Via Dott. Angelo Camposeo, 23<br />70010 Turi (BA)<br />Puglia, Italia</p>
                                </div>
                                ...
                                <div className="flex items-center space-x-3 group">
                                    ...
                                    <a href="https://wa.me/393770802322" className="text-gray-300 hover:text-white transition-colors">+39 377 080 2322</a>
                                </div>
                                ...
                                <div className="flex items-center space-x-3 group">
                                    ...
                                    <a href="mailto:info@idealstampa.com" className="text-gray-300 hover:text-white transition-colors">info@idealstampa.com</a>
                                </div>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                            ...
                            <div className="flex flex-wrap justify-center gap-4 text-sm">
                                {legalLinks.map((link, index) => (
                                    <a key={index} href={link.href} className="text-gray-400 hover:text-white transition-colors">{link.name}</a>
                                ))}
                            </div>
                        </div>
                    </div>
